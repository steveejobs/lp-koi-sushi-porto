...
const presencePoints = [
  ...
  },
  {
    ...
    text: "Escolha as opções do menu e envie o pedido pelo WhatsApp.",
  },
];
    ...
    <section id="ambiente" className="section-pad bg-[#16110d] text-[#fff8ed]">
      <div className="container-page">
        <div className="grid gap-8 md:grid-cols-[0.78fr_1.22fr] md:items-end">
          <div>
            <span className="eyebrow text-[#b8924a]">Ambiente</span>
          ...
          <p className="max-w-xl text-base font-semibold leading-7 text-[#efe2c8]/78 md:justify-self-end md:text-lg">
            Um espaço acolhedor no Porto para Menu Infinity, All You Can Eat,
            sushi, cozinha chinesa e Take Away.
          </p>
        </div>
        ...
        <div className="mt-9 grid gap-4 lg:grid-cols-[1.35fr_0.65fr]">
          <figure className="image-soft relative min-h-[320px] overflow-hidden rounded-lg bg-neutral-950 md:min-h-[560px]">
            ...
            <figcaption className="absolute bottom-5 left-5 right-5 max-w-md text-white">
              <span className="block h-1.5 w-10 rounded-full bg-[#a91f24]" />
          ...
          <div className="grid gap-4 sm:grid-cols-3 lg:grid-cols-1">
            {presencePoints.map((point) => (
              <article
                key={point.title}
                className="rounded-lg border border-[#b8924a]/14 bg-[#0f0d0a] p-5 shadow-sm"
              >
                <div className="mb-6 h-1.5 w-10 rounded-full bg-[#a91f24]" />
            ...
            <article className="rounded-lg bg-[#a91f24] p-5 text-white shadow-[0_20px_42px_rgba(0,0,0,0.18)] sm:col-span-3 lg:col-span-1">
